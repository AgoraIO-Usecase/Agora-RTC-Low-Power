...
- (void)loadAgoraKit {
    ...
    [self.rtcEngine setVideoResolution:(CGSizeMake(240, 320)) andFrameRate:(10) bitrate:(300)];
    [self.rtcEngine setClientRole:self.clientRole];
    [self.rtcEngine setParameters:(@"{\"che.audio.enable.howling_control\":true}")];
    [self.rtcEngine setParameters:(@"{\"che.audio.enable.livehc\":true}")];
    [self.rtcEngine setParameters:(@"{\"che.audio.enable.agc\":false}")];

    [self.rtcEngine setParameters:(@"{\"che.audio.specify.codec\":\"G722\"}")];

    [self.rtcEngine setAudioProfile:(AgoraAudioProfileDefault) scenario:(AgoraAudioScenarioChatRoomGaming)];
...
//    [self.rtcEngine setParameters:(@"{\"che.audio.voice_over_mode\": true}")];
//    [self.rtcEngine setParameters:(@"{\"che.audio.voice_only_mode\": true}")];
//    [self.rtcEngine setParameters:(@"{\"che.audio.voiceonly_mode\": true}")];
}
